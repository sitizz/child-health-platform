...
import { Text, View, Pressable, StyleSheet, ScrollView, Switch, Share } from 'react-native';
...
Generated by Child Health Platform.
`;
      ...
      {result && (
        <View style={styles.section}>
          ...
          <View style={styles.actionCard}>
            ...
            <Text style={styles.actionSectionTitle}>Immediate</Text>
            <Text style={styles.actionText}>
              {result.recommended_action?.immediate || result.action}
            </Text>

            <Text style={styles.actionSectionTitle}>Caregiver</Text>
            {result.recommended_action?.caregiver?.map((item: string, index: number) => (
              <Text key={index} style={styles.actionText}>• {item}</Text>
            ))}

            <Text style={styles.actionSectionTitle}>When to Escalate</Text>
            <Text style={styles.actionText}>
